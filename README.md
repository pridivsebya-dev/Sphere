...
Готовый jar: `target/ElytrixAnimAddon-1.17.jar` (требуется JDK 17 и доступ к
`repo.by1337.space` — там лежат BCases-common и VirtualEntityApi).

## Установка

1. Положите `ElytrixAnimAddon-1.17.jar` в папку аддонов BCases (обычно `plugins/BCases/addons/`).
