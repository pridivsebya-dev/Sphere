...
Готовый jar: `target/ElytrixAnimAddon-1.19.jar` (требуется JDK 17 и доступ к
`repo.by1337.space` — там лежат BCases-common и VirtualEntityApi).

## Установка

1. Положите `ElytrixAnimAddon-1.19.jar` в папку аддонов BCases (обычно `plugins/BCases/addons/`).
